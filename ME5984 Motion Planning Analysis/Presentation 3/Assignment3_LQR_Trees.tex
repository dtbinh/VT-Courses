...
%\item Today:
%\begin{itemize}
%\item Lyapunov functions and SOS
%\item LQR, its design and verification
%\item Overview of Motion planning
%\item RRT algorithm
%\end{itemize}
%\vspace{.2cm}
%\item Next week:
%\begin{itemize}
%\item Trajectory Optimization and Time varying LQR
%\item LQR trees algorithm
%\item LQR trees in action (Simulation)
%\end{itemize}
%\end{itemize}
